  ...
  return (
    <section className="top-panel mb-6 bg-[linear-gradient(135deg,rgba(61,46,32,0.96),rgba(92,68,51,0.98))] text-[var(--soy-cream-100)]">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        ...
        <form action={onComplete} className="flex gap-3">
          <button className="button-secondary bg-white/10 text-white" type="submit">
            Skip for now
          </button>
      ...
      <div className="mt-6 grid gap-3 md:grid-cols-4">
        {[
          ...
          <div key={step} className="rounded-3xl border border-white/10 bg-white/5 p-4">
            <div className="text-xs uppercase tracking-[0.16em] text-[var(--soy-amber-300)]">
              Step {index + 1}
            </div>
